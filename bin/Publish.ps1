...
copy-item (join-path $distDir "Vintageous_Plugin_Surround.sublime-package") $targetDir -force

if ($Release -and (!$DontUpload)) {
	start-process "https://bitbucket.org/guillermooo/vintageous_plugin_surround/downloads"
